      ...
      <SidebarMenuItem>
        <CollapsibleTrigger asChild>
          {item.subItems ? (
            ...
            <SidebarMenuButton asChild aria-disabled={item.badge} isActive={isActive(item.url)} tooltip={item.title}>
            ...
            <SidebarMenuSub>
              {item.subItems.map((subItem) => (
                <SidebarMenuSubItem key={subItem.title}>
                  <SidebarMenuSubButton aria-disabled={subItem.badge} isActive={isActive(subItem.url)} asChild>
          ...
          {item.subItems?.map((subItem) => (
            <DropdownMenuItem key={subItem.title} asChild>
              <SidebarMenuSubButton
                ...
                aria-disabled={subItem.badge === "soon"}
                isActive={isActive(subItem.url)}
              >
                <Link prefetch={false} href={subItem.url} target={subItem.newTab ? "_blank" : undefined}>
                  {subItem.icon && <subItem.icon className="[&>svg]:text-sidebar-foreground" />}
                  <span>{subItem.title}</span>
                  {subItem.badge === "soon" && <IsComingSoon />}
                </Link>
              </SidebarMenuSubButton>
            </DropdownMenuItem>
          ))}
